...
using Weixin.Netcore.Core.Configuration.DependencyInjection.Options;
using Weixin.Netcore.Core.Exceptions;
using Weixin.Netcore.Core.InterfaceCaller;
using Weixin.Netcore.Core.JsApi;
...
namespace Weixin.Netcore.Core.Configuration.DependencyInjection
{
    /// <summary>
    /// 添加Weixin.Netcore的DI扩展
    /// </summary>
