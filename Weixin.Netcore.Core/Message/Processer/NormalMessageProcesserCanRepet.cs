...
namespace Weixin.Netcore.Core.Message.Processer
{
    ...
    /// 消息处理器（普通消息）- 无重复验证
    /// </summary>
    public class NormalMessageProcesserCanRepet : IMessageProcesser
    {
        ...
        public NormalMessageProcesserCanRepet(ITextMessageHandler textMessageHandler, IImageMessageHandler imageMessageHandler,
