...
namespace Weixin.Netcore.Core.Message.Processer
{
    ...
    /// 消息处理器（所有消息）- 无重复验证
    /// </summary>
    public class MessageProcesserCanRepet : IMessageProcesser
    {
        ...
        public MessageProcesserCanRepet(ITextMessageHandler textMessageHandler, IImageMessageHandler imageMessageHandler,
